...
If you need to add an edge between a column node to another (and not
between the line node and a column node), you can use the
``from_subject`` predicate, for example:
